...
PIPELINE_VERSION = "ResearchLab_v1.0.15_PIT"
...
def _assert_frozen_pipeline():
    ...
    actual_config = _config_fingerprint()
    ...
    if actual_config != EXPECTED_CONFIG_SHA256:
        raise RuntimeError(
            "Frozen EUR/USD A/B/E configuration changed. Refusing to continue. "
            f"Expected {EXPECTED_CONFIG_SHA256}, got {actual_config}."
        )
...
def _append_missing_observations(
    ...
    candidate = common[common.index >= SHADOW_START_DATE]
