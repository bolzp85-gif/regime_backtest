...
st.title("🧪 Regime Backtest Lab v1.0.5 – WTI Validity Check")
st.caption(
...
- **Sentiment-Zusatz:** CNN Fear & Greed
- **Makro/FRED:** `WALCL`, `WTREGEN`, `RRPONTSYD`, `FEDFUNDS`, `DFII10`
- **Fundamental / physischer Markt:** `WCESTUS1` – US Crude Oil Stocks

Die WTI-Lagerbestände werden separat über FRED/ALFRED geladen. Wenn
First-Release-Daten verfügbar sind, werden sie nach ihrem ersten bekannten
Verfügbarkeitstag verwendet; ansonsten wird der bereits transparente
Current-Vintage-Fallback mit konservativem Lag genutzt.
...
if selected_asset == "Gold (XAU/USD)":
    ...
    st.info(
        "🛢️ **WTI-Test v1.0.5:** Die v1.0.4-Methodik bleibt unverändert: "
        "relative Modellvergleiche, Absolute Direction-/Risk-Gates, "
        "Common Sample, Block-Bootstrap, Ablation und MAE. Neu ist nur "
        "die WTI-spezifische Quell- und Faktordiagnose – insbesondere "
        "für `WCESTUS1` (US-Rohöllagerbestände)."
    )
