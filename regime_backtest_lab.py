...
st.title("🧪 Regime Backtest Lab v1.0.11 – WTI Walk-Forward Validation")
st.caption(
...
st.caption(
    "Der Export enthält jetzt A/Current, B/Literature, C/Equal Weight "
    "sowie die Diagnosemodelle D/Lit-Subweights-only und "
    "E/Lit-Pillars-only inklusive Coverage und Forward-Targets. "
    "Damit kann der Model-D-Bestätigungstest vollständig offline "
    "nachgerechnet werden. Research-Datenmaterial – keine "
...
if (
    ...
    st.download_button(
        "⬇️ WTI Walk-Forward Komplettpaket als ZIP",
        data=wf_zip_buffer.getvalue(),
        file_name=(
            "WTI_Model_D_Walk_Forward_v1_0_11.zip"
        ),
