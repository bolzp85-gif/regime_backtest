...
st.title("🧪 Regime Backtest Lab v1.0.3 – Gold")
st.caption(
...
with st.sidebar:
    ...
    selected_asset = (
        st.selectbox(
            ...
            index=2,
            help=(
                "Für den nächsten Vergleich ist Gold (XAU/USD) voreingestellt. "
...
ob niedrige Scores künftige Gold-Drawdowns und höhere Volatilität zuverlässiger
