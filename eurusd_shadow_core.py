...
No model re-optimization, no bfill, and no dependency on future edits of
regime_engine.py. The EUR/USD configuration is embedded in this file.
"""
...
def fetch_sp500_pe_history():
    return pd.Series(dtype=float), False, "Not used by EUR/USD shadow"
...
# ============================================================
# EUR/USD TRUE FUTURE HOLDOUT
# ============================================================
# Model-selection and evaluation rules live in the logger/evaluator.
